document.addEventListener("DOMContentLoaded", () => {
    const API_URL = "https://67697b74863eaa5ac0dbcaab.mockapi.io/incomecalculator/entries"; // Replace with your MockAPI URL.
    ...
    async function editEntry(entry) {
        ...
        await deleteEntry(entry.id); // Delete old entry to replace it
    }
